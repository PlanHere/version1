...
<head><? require_once 'connection.php';?>
    ...
    <title>Marriage Venues | Plan Here</title>
...
<div class="container margin_60">
   ...
   <form action="wedding_grid_filter.php" method="get">
		<div id="filters_col">
			...
			<div class="collapse in" id="collapseFilters">
				...
				<div class="filter_type">
					<h6>Category</h6>
					<ul>
						<li><label><input type="checkbox" name="cat[]" value="any">Any</label></li>
						<li><label><input type="checkbox" name="cat[]" value="convenction">Convenction Center</label></li>
						<li><label><input type="checkbox" name="cat[]" value="weedings_ex">Weedings Exclusive</label></li>
						<li><label><input type="checkbox" name="cat[]" value="outskirts">Outskirts</label></li>
						<li><label><input type="checkbox" name="cat[]" value="picturesque">Picturesque</label></li>						<li><label><input type="checkbox" name="cat[]" value="outskirts">Midnight</label></li>
						<li><label><input type="checkbox" name="cat[]" value="unwind">Unwind</label></li>						<li><label><input type="checkbox" name="cat[]" value="outskirts">Midnight</label></li>
						<li><label><input type="checkbox" name="cat[]" value="farmhouse">Farm House</label></li>
				...
				<div class="filter_type">
					<h6>Capacity</h6>
					<ul>
						<li><label><input type="checkbox" name="capacity[]" value="100">100 - 500</label></li>
						<li><label><input type="checkbox" name="capacity[]" value="500">500 - 1000</label></li>
						<li><label><input type="checkbox" name="capacity[]" value="1000">1000 - 1500</label></li>
						<li><label><input type="checkbox" name="capacity[]" value="1500">1500 - 2000</label></li>
						<li><label><input type="checkbox" name="capacity[]" value="2000">2000+</label></li>
					</ul>
				</div>
								<div class="filter_type">
					<h6>Facilities</h6>
					<ul>
						<li><label><input type="checkbox" name="facilities[]" value="ac">Air Conditioned</label></li>
						<li><label><input type="checkbox" name="facilities[]" value="wifi">Wifi</label></li>
						<li><label><input type="checkbox" name="facilities[]" value="delivery">Catering</label></li>
						<li><label><input type="checkbox" name="facilities[]" value="music">Live Music</label></li>
						<li><label><input type="checkbox" name="facilities[]" value="hookha">Buffet</label></li>
		...
		<div class="col-lg-9 col-md-8">
			...
			<div class="row">
				<?php
					...
					include 'pagination_wedding.php';
				?>
				...
				<div class="text-center">
					<ul class="pagination">
						...
						if($count>10 && $count<20){
							if($prev=='0'||$page=='0'||$page=='1'){
								echo '<li class="disabled" onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page='.$prev.'">Prev</a></li>';
								$next=2;
							}
							else {
								echo '<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page='.$prev.'">Prev</a></li>';
							}
							?>
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=1">1</a></li>
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=2">2</a></li>
						<?php if($page=='2'||$page>'2'){
								$next='3';
								echo '<li class="disabled" onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page='.$next.'">Next</a></li>';
							
						}
							else{
								echo '<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page='.$next.'">Next</a></li>';
							}}
						...
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=1">1</a></li>
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=2">2</a></li>
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=2">3</a></li>
						<?php if($next>'3'){
								echo '<li class="disabled" onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page='.$next.'">Next</a></li>';
						...
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=2">2</a></li>
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=2">3</a></li>
						<li onclick="pagination.submit();"><a href="http://localhost/version2/marriage_grid.php?page=2">4</a></li>
