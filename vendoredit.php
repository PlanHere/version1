...
<head>
    ...
    <title>Vendor Edit  | Plan Here</title>
    	...
    	<div class="row">
    		<div class="col-md-8 col-sm-8">
    					...
    					<div class="row">
    						<div class="col-md-6 col-sm-6">
    							<div class="form-group">
    								...
    								<input type="text" id="email_contact" name="email_contact" class="form-control" placeholder="Change Password">
    							</div>
    						</div>
                <div class="col-md-6 col-sm-6">
    							<div class="form-group">
    								<label>Email<sup>*</sup></label>
    								<input type="Email" id="email_contact" name="email_contact" class="form-control" placeholder="Change Email">
    							</div>
    						</div>
    					</div>
              <div class="row">
    						<div class="col-md-12">
    							<div class="form-group">
    								...
    								<textarea rows="3" id="message_contact" name="message_contact" class="form-control" placeholder="Write your Address" style="height:200px;"></textarea>
    							</div>
    						</div>
    					</div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="col-md-3" >Meal<sup>*</sup></label>
                    <div class="col-md-9">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="col-md-3" >International Cusines<sup>*</sup></label>
                    <div class="col-md-9">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="col-md-3" >Indian Cusines<sup>*</sup></label>
                    <div class="col-md-9">
                      <div class="checkbox">
                          <label>
                      ...
                      <div class="checkbox">
                          <label>
                              <input type="checkbox" value="guj" name="indcus[]">Gujarati
                          </label>
                      </div>
                      <div class="checkbox">
                          <label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="col-md-3" >Specials<sup>*</sup></label>
                    <div class="col-md-9">
                      <div class="checkbox">
                          <label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="col-md-3" >Facilities<sup>*</sup></label>
                    <div class="col-md-9">
                      <div class="checkbox">
                          <label>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="email_contact" name="email_contact" class="form-control" placeholder="Website">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label>Facebook page<sup>*</sup></label>
                    <input type="text" id="email_contact" name="email_contact" class="form-control" placeholder="Fbpage">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label>Price per night<sup>*</sup></label>
                    <input type="text" id="email_contact" name="email_contact" class="form-control" placeholder="Website">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class=" col-md-3">Upload Image<sup>*</sup></label>
                        <input class="col-sm-9" type="file" name="logo" />
                    </div>
                </div>
              </div>
    					<div class="row">
    						<div class="col-md-12">
    							<div class="form-group">
    								...
    								<textarea rows="5" id="message_contact" name="message_contact" class="form-control" placeholder="Write your Description" style="height:200px;"></textarea>
    							</div>
    						</div>
    					</div>
    					<div class="row">
