...
<section id="search_container">
 	<div id="search">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tours" data-toggle="tab">Hotel</a></li>
                        <li><a href="#hotels" data-toggle="tab">Marriages</a></li>
                        <li><a href="#transfers" data-toggle="tab">Others</a></li>
                    </ul>
                    
                    <div class="tab-content">
                        <div class="tab-pane active" id="tours">
                        <h3>Book a Table in Your Favourite Restaurant</h3>
                        	<div class="row">
                            	<div class="col-md-6">
    ...
    <div class="white_bg">
        <div class="container margin_60">
            ...
            <div class="banner colored add_bottom_30">
                ...
                <p>
                    You just need to decide how it's gonna happen and you are in the right place to think over and plan it!
                </p>
                <a href="single_tour.html" class="btn_1 white">Plan Now</a>
            </div>
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    ...
                    <h4><span>Event </span> Planners</h4>
                    <p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    ...
                    <h4><span>Marriage </span> Halls</h4>
                    <p>
                        Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex.
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 text-center">
                    ...
                    <h4><span>Catters</span> booking</h4>
                    <p>
                        Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex.
                    </p>
                </div>
    ...
    <div class="container margin_60">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <h3>Get started with <span>Plan Here</span></h3>
                <p>
                ...
                <a href="#search" class="btn_1">Plan Now</a>
            </div>
        </div><!-- End row -->
